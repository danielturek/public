...
##- The value of X (indicated by the y-axis label) is either: *ESS*, the effective sample size (runsulting from 100,000 MCMC samples), or, *Efficiency*, the effective sample size per second of algorithm run-time.
